...
class ProductSearchResultPage extends StatefulWidget {
  ...
  const ProductSearchResultPage({super.key, required this.searchQuery});

  @override
  State<ProductSearchResultPage> createState() =>
...
class _ProductSearchResultPageState extends State<ProductSearchResultPage> {
              ...
              child: AnimatedSwitcher(
                ...
                child: _isLoading
                    ...
                    : SingleChildScrollView(
                        key: const ValueKey('product-search-results-content'),
                        child: Column(
  ...
  Widget _buildLoadingState() {
    return SingleChildScrollView(
      key: const ValueKey('product-search-results-loading'),
            ...
            child: Container(
              ...
              child: const Padding(
                ...
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    SkeletonLoading(width: 88, height: 112, borderRadius: 10),
                    SizedBox(width: 12),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
