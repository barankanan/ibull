                  ...
                  child: Padding(
                    ...
                    child: FlutterMap(
                      ...
                      children: [
                        ...
                        MarkerLayer(
                          markers: _businesses.asMap().entries.map((entry) {
                            ...
                            switch (category) {
                              case 'restoran':
                                ...
                                break;
                              case 'teknoloji':
                                markerIcon = Icons.devices;
                                break;
                              case 'giyim':
                                markerIcon = Icons.checkroom;
                                break;
                              case 'market':
                                markerIcon = Icons.shopping_cart;
                                break;
                              case 'kozmetik':
                                markerIcon = Icons.face_retouching_natural;
                                break;
                              case 'kitap':
                                markerIcon = Icons.menu_book;
                                break;
                              case 'oyuncak':
                                markerIcon = Icons.toys;
                                break;
                              case 'tamir':
