...
class ProductInfoSection extends StatelessWidget {
    ...
    return Column(
      ...
      children: [
        ...
        ...viewModel.allAvailableOptions.entries.map((entry) {
          ...
          final isColor =
              optionKey.toLowerCase().contains('renk') ||
              optionKey.toLowerCase().contains('color');
                ...
                SizedBox(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isSelected =
                          viewModel.selectedVariants[optionKey] == optionValue;
                      ...
                      final isAvailable = viewModel
                          .hasInStockVariantForSelection(tempSelection);
                      ...
                      return GestureDetector(
                        onTap: isAvailable
                            ? () {
                                ...
                                if (target != null &&
                                    target.name !=
                                        viewModel.initialProduct.name) {
                                  Navigator.pushReplacement(
                                    context,
                                    MaterialPageRoute(
                                      builder: (_) =>
                                          ProductDetailPage(product: target),
                                    ),
                                  );
                                }
                              }
                        ...
                        child: Container(
                          padding: EdgeInsets.symmetric(
                            horizontal: isColor ? 8 : 12,
                            vertical: isColor ? 4 : 5,
                          ),
  ...
  Color _getColorFromName(String name) {
    ...
    if (lower.contains('gri') ||
        lower.contains('gray') ||
        lower.contains('grey'))
      return Colors.grey;
    if (lower.contains('kahve') || lower.contains('brown')) return Colors.brown;
    if (lower.contains('titan') || lower.contains('titanium'))
      return const Color(0xFF8E8E93);
    if (lower.contains('gümüş') || lower.contains('silver'))
      return const Color(0xFFC0C0C0);
    if (lower.contains('altın') || lower.contains('gold'))
