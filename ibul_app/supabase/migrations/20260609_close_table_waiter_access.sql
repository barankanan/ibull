...
-- ─── 4) close_restaurant_orders_for_table — fallback missing RPC eklentisi ─
CREATE OR REPLACE FUNCTION public.close_restaurant_orders_for_table(
  p_seller_id      uuid,
  p_table_number   integer
)
RETURNS integer
...
GRANT EXECUTE ON FUNCTION public.close_restaurant_orders_for_table(uuid, integer) TO authenticated;
